    ...
    return (
        <div className="register-page" data-testid="register-page">
            ...
            <form onSubmit={handleSubmit} className="register-form" data-testid="register-form">
                <Input label="Full Name" type="text" value={name} onChange={(e) => setName(e.target.value)} helper="Enter your full name" data-testid="register-name" />
                <Input label="Email Address" type="email" value={email} onChange={(e) => setEmail(e.target.value)} helper="Use your account email" data-testid="register-email" />
                <Input label="Password" type={showPwd ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} helper="Minimum 6 characters" data-testid="register-password" />
                ...
                <Input label="Confirm Password" type={showConfirmPwd ? 'text' : 'password'} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Type Password" data-testid="register-confirm-password" />
